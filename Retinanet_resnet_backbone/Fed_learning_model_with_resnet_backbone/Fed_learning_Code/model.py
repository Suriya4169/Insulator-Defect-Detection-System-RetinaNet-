...
def get_model(num_classes):
    ...
    # Custom Focal Loss Alpha for Class Balancing
    # Defect (Class 1) is still the hardest, so we boost it to 0.75
    # Insulator (Class 2) and Background (Class 0) get 0.25
