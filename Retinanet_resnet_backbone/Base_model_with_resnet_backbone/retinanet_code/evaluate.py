...
class Config:
    # Paths
    DATA_PATH = r'D:\Fed learning project\Insulator-Defect-Detection-System-RetinaNet-\Retinanet_resnet_backbone\Dataset - IDD-CPLID.v3-cplid_new.coco'
    CHECKPOINT_PATH = r'./checkpoints/best_model.pth'
    REPORT_DIR = r'./reports'
    SAMPLE_IMAGE_PATH = os.path.join(DATA_PATH, 'test', '0051_jpg.rf.083ebc89eb22b485781cf7f898cdcbf8.jpg')
